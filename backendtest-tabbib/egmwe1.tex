...
@techreport{calkin,
  ...
  year         = {2011},
  pages        = {8--9},
  author+an={=important;1=thesisauthor}
}

@incollection{buseck1,
  author       = {Buseck, P R and Nord, Jr, G L and Veblen, D R and Calkin, D},
...
@incollection{buseck2,
  author       = {Buseck, P R and Calkin, D and Nord, Jr, G L and Veblen, D R },
  title        = {Subsolidus Phenomena in Pyroxenes},
  booktitle    = {Pyroxense},
  address      = {Washington, D.C.},
  publisher    = {Mineralogical Society of America},
...
\end{filecontents}
    ...
    文献\cite{wfz,zgtsgxh,calkin,buseck1,buseck2}
