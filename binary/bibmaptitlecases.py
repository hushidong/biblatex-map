...
sourcemaps=[
    [#map1:将设置title为sentencecase
        {"fieldsource":"date","extract":r"(\d\d\d\d)","notinrange":['1995','2005'],"final":True},#
        {"fieldsource":"title","final":True},#
        {"fieldset":"title","origfieldval":True,"fieldfunction":'setsentencecase',"overwrite":True}#step1
    ],
    [#map2:将设置title为sentencecase
        {"fieldsource":"entrykey","in":['southey2005bayes','Silver2017Mastering'],"final":True},#
        {"fieldsource":"title","final":True},#
        {"fieldset":"title","origfieldval":True,"fieldfunction":'setsentencecase',"overwrite":True}#step1
    ]
]
